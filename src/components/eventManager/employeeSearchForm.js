...
const EmployeeSearchForm = ({
 ...
 asignedEmployeesList,
  ...
  const [selectedCategory, setSelectedCategory] = useState("Add or Remove assigned employees here");
  ...
  const searchEmployees = async(searchName) => {
      await axios.get("http://65.2.129.99/api/eventManager/employee/EmployeesandSearch", { params: { empName: searchName} })
      .then(res => {
                    ...
                    >
                      ...
                      <p className="block font-sans text-sm antialiased font-normal leading-normal text-gray-700">
                        ...
                        {resultDisplayfield2 == "date"
                          ...
                          : "@ " +result['department']?.departmentName + " " + "department"}
