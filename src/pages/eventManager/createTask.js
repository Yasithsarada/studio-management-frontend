...
const CreateTask = () => {
  ...
  const [isSelectedEventError, setIsSelectedEventError] = useState(false);
  const [isTaskNameError, setIsTaskNameError] = React.useState(false);
  ...
  //     .get("http://65.2.129.99/api/eventManager/all-events")
  //     .then((res) => {
  ...
  const createTask = () => {
    ...
    if (isTaskNameError || isStatusError  ) {
      return;
    }
    ...
    const response = axios
      .post("http://65.2.129.99/api/eventManager/tasks/create", {
  ...
  const getEventCategories = () => {
    axios
      .get("http://65.2.129.99/api/eventManager/event-categories")
      .then((res) => {
  ...
  const getEmployees = () => {
    ...
    const response = axios
      .get("http://65.2.129.99/api/employeeManager/getEmployees")
      .then((res) => {
        console.log("reeeeeeeeeeeeeeeeres" , res.data);
        ...
        <tr className="flex   mt-8">
          <div className="  w-full flex justify-center">
            <div className="flex flex-col gap-8 mb-1 p-4 w-8/12 justify-center">
              ...
              <Input
                size="lg"
                error={isTaskNameError ? "true" : null}
                placeholder="Task Name"
              ...
              />
              {isTaskNameError==true ?  <p className="m-0 text-red-500 ">Fill out here</p> : ""}
              ...
              <Select
                    ...
                    error={isSelectedEventError ? "true" : null}
              ...
              <Select
                    ...
                    {isStatusError ==true ?  <p className="mt-1 text-red-500 ">Fill out here</p> : ""}
              </div>
              <h6 className="block -mb-3 font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-blue-gray-900">
                Employee
              </h6>
