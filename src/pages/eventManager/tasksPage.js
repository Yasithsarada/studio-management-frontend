...
const TaskPage = () => {
  ...
  const getTasks = () => {
    setLoading(true);
    axios.get(`http://65.2.129.99/api/eventManager/tasks/all-tasks/?page=${active}&limit=8`)
    .then( (response) => {
  ...
  const taskSearch = (taskName) => {
    axios
    .post("http://65.2.129.99/api/eventManager/task/searchTaskName", {
      taskName: taskName,
  ...
  //   axios
  //   .post("http://65.2.129.99/api/eventManager/task/deleteTask", {
  //     // taskName: taskName,
  ...
  //   await axios
  //     .post("http://65.2.129.99/api/eventManager/task/deleteTask", {}, { params: { taskId: taskId } })
  //     .then((response) => {
  //       console.log("tasks -  : ", response);
  //       console.log("delete ");
  //       console.log(response.data);
  ...
  const taskDelete = async (taskId) => {
    console.log("tasks id -  : ", taskId);
       ...
       await axios.post(
        "http://65.2.129.99/api/eventManager/task/deleteTask",
        {},
        { params: { taskId: taskId } }
      ).then((res) => {
  ...
  const getSelectedDayEvents = (date) => {
    ...
    axios
      .post("http://65.2.129.99/api/eventManager/task/searchTaskDate", {
        date: date,
      })
      .then((res) => {
